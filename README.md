...
### Directories
..* input: contains .bam files that can be used as input in the pipeline. For more information on the .bam file data included in the repository see the *data* section 
..* output: is an empty directory that output files from the workflow can be directed into 
..* reference_genome: contains the fasta file for the GRCH37-lite human reference genome. For more information on this genome and where to download it see the *data* section 
...
[I'm an inline-style link](https://doi.org/10.1016/j.cell.2019.10.026). 
...
[I'm an inline-style link](https://catalog.coriell.org/0/Sections/Search/Sample_Detail.aspx?Ref=GM18507).
...
[I'm an inline-style link](https://www.bcgsc.ca/downloads/genomes/9606/hg19/1000genomes/bwa_ind/genome)
